...
namespace ScanFlowAWS.Web.Services
{
    public class AnalyzeImageService : IAnalyzeImageService
    {
        ...
        public async Task<List<ResponseAnalyzeFacesJson>?> AnalyzeFacesAsync(IBrowserFile imageFile)
        {
            ...
            return await response.Content.ReadFromJsonAsync<List<ResponseAnalyzeFacesJson>>();
        }
